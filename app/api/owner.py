...
@router.post("/create_owner/", response_model=Owner)
...
@router.patch("/update_owner/v/{owner_id}", response_model=Owner)
...
@router.post("/deactivate_owner/v/{owner_id}")
...
@router.get("/get_owner/v/{owner_id}", response_model=Owner)
...
@router.get("/get_owners/", response_model=List[Owner])
